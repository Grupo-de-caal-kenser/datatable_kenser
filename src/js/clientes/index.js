...
const buscar = async () => {
    ...
    const url = `/datatable_kenser/API/clientes/buscar?cliente_nombre=${cliente_nombre}&cliente_nit=${cliente_nit}`;
    const config = {
        method : 'GET'
    }
...
const guardar = async (evento) => {
    ...
    const url = '/datatable_kenser/API/clientes/guardar';
...
const modificar = async () => {
    ...
    const body = new FormData(formulario)
    const url = '/datatable_kenser/API/clientes/modificar';
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (e) => {
    ...
    if(await confirmacion('warning','¿Desea eliminar este registro?')){
        ...
        body.append('cliente_id', id)
        const url = '/datatable_kenser/API/clientes/eliminar';
        const headers = new Headers();
        headers.append("X-Requested-With","fetch");
        const config = {
            method : 'POST',
